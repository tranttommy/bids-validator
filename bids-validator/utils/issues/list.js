...
export default {
  ...
  133: {
    ...
    severity: 'error',
    reason:
      "You should define 'LabelingType' for this file. 'LabelingType' can be CASL, PCASL, PASL.",
  },
  134: {
  ...
  152: {
    ...
    severity: 'error',
    reason:
      "You should define the 'IntendedFor' for this file. 'IntendedFor' indicates one or more filenames with paths relative to the subject subfolder, with forward slashes, referring to ASL timeseries for which the 'm0scan' is intended.",
  },
  153: {
    key: 'M0_NOT_SET',
    severity: 'error',
  ...
  154: {
    ...
    severity: 'warning',
    reason:
      "M0 was not defined correctly. If 'M0' is equal to true/false, the corresponding 'sub-<label>[_ses-<label>][_acq-<label>][_rec-<label>][_run-<index>]_aslcontext.tsv' should contain the 'm0scan'/'control' volume respectively.",
  },
  155: {
    key: 'PULSE_SEQUENCE_TYPE_MUST_DEFINE',
    severity: 'error',
    reason:
      "You should define 'PulseSequenceType' for this file. 'PulseSequenceType' is the general description of the pulse sequence used for the scan. Allowed values are any combination of 2D or 3D acquisition, with the read-out type, separated by an underscore: e.g. “2D_EPI”, “3D_GRASE”, “3D_spiral”.",
  },
  156: {
  ...
  165: {
    ...
    severity: 'error',
    reason:
      "The number of volumes in the 'sub-<label>[_ses-<label>][_acq-<label>][_rec-<label>][_run-<index>]_aslcontext.tsv' for this file does not match the number of values in the NIfTI header.",
  },
  166: {
    key: 'LOOK_LOCKER_FLIP_ANGLE_MISSING',
    severity: 'error',
    reason:
      "You should define 'FlipAngle' for this file, in case of a LookLocker acquisition. 'FlipAngle' is the flip angle for the acquisition, specified in degrees, either as a number or an array of numbers, with the length corresponding to the number of volumes. Corresponds to: DICOM Tag 0018, 1314 Flip Angle.",
  },
  167: {
    key: 'FLIP_ANGLE_MISSING',
    severity: 'warning',
    reason:
      "It is recommended to define 'FlipAngle' for this file. 'FlipAngle' is the flip angle for the acquisition, specified in degrees, either as a number or an array of numbers, with the length corresponding to the number of volumes. Corresponds to: DICOM Tag 0018, 1314 Flip Angle.",
  },
  168: {
  ...
  171: {
    ...
    severity: 'error',
    reason:
      "The field 'VolumeTiming' requires 'AcquisitionDuration' be defined.",
  },
  172: {
    key: 'FLIP_ANGLE_NOT_MATCHING_ASLCONTEXT_TSV',
    severity: 'error',
    reason:
      "The number of values for 'FlipAngle' for this file does not match the number of volumes in the 'sub-<label>[_ses-<label>][_acq-<label>][_rec-<label>][_run-<index>]_aslcontext.tsv'. 'FlipAngle' is the flip angle for the acquisition, specified in degrees, either as a number or an array of numbers, with the length corresponding to the number of volumes. Corresponds to: DICOM Tag 0018, 1314 Flip Angle.",
  },
  173: {
  ...
  187: {
    ...
    severity: 'warning',
    reason:
      "'LabelingDuration' is greater than 10, are you sure it's expressed in seconds? 'LabelingDuration' is the total duration of the labeling pulse train, in seconds, corresponding to the temporal width of the labeling bolus for (P)CASL. Specify either one number for total time-series or provide an array of numbers of different values for each volume in case of sequential acquisitions with varying labeling duration. In the case that an array of numbers is provided, its length should be equal to the number of volumes specified in 'sub-<label>[_ses-<label>][_acq-<label>][_rec-<label>][_run-<index>]_aslcontext.tsv'. An 'm0scan' acquired within the ASL time-series, gets a value of zero. Corresponds to DICOM Tag 0018,9258 ASL Pulse Train Duration.",
  },
  188: {
  ...
  189: {
    ...
    severity: 'error',
    reason:
      "You defined one of the not allowed fields in case of CASL or PCASL 'LabelingType'. Please verify which field among 'PASLType', 'LabelingSlabThickness' 'BolusCutOffFlag', 'BolusCutOffTimingSequence', 'BolusCutOffDelayTime' and 'BolusCutOffTechnique' you have filled.",
  },
  190: {
    key: 'PASL_NOT_ALLOWED_FIELDS',
    severity: 'error',
    reason:
      "You defined one of the not allowed fields in case of PASL 'LabelingType'." +
  ...
  191: {
    ...
    severity: 'error',
    reason:
      "You defined either the 'CASLType' with a PCASL 'LabellingType' or the 'PCASLType' with a CASL 'LabellingType'. This is not allowed, please check that these field are filled correctly.",
  },
  192: {
  ...
  193: {
    ...
    severity: 'error',
    reason:
      "You must define 'EchoTime' for this file. 'EchoTime' is the echo time (TE) for the acquisition, specified in seconds. Specify either one number for the total time-series, or provide an array of numbers with different values of each volume. Corresponds to DICOM Tag 0018, 0081 Echo Time (please note that the DICOM term is in milliseconds not seconds).",
  },
  194: {
    key: 'RECOMMENDED_KEYWORD',
    severity: 'warning',
    reason: 'This key/value pair is recommended by the specification.',
  },
  195: {
    key: 'PROHIBITED_KEYWORD',
    severity: 'error',
    reason: 'This key/value pair is forbidden in this JSON object.',
  },
}
